...
PATH_TO_SAVE = "/Users/ntdat/Downloads/DownloadFromYoutube/Cropped"
        ...
        if len(outputs) != 0:
            ...
            for output in outputs:
                try:
                    ...
                    cv2.imwrite(os.path.join(PATH_TO_SAVE, "cropped_" + str(count) + ".jpg"), img_cropped)
                    count += 1
...
read_video("/Users/ntdat/Downloads/DownloadFromYoutube/Trên tay khẩu trang Unicharm.mp4")
