...
SAVE_FOLDER = "/Users/ntdat/Documents/FaceRecognitionResearch/CompanyProject/Data/Unsure_model_arcface"

accuracy_logs_content = ""

with open("/Users/ntdat/Documents/FaceRecognitionResearch/CompanyProject/fid-face/accuracy_logs", "r") as f:
...
for idx, line in enumerate(accuracy_logs_content.split("\n")):
    try:
        ...
        #     cv2.putText(img, pred_id, (50, 50), fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=1, color=(0, 255, 0))
        #
