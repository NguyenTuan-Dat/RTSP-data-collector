...
def get_symbol(input_shape=(3, 224, 224), num_classes=256, mode="small", **kwargs):
    net = MobileNetV3(input_shape=input_shape, num_classes=num_classes, mode=mode)
    net.collect_params().initialize(mx.init.Xavier(magnitude=2.24, rnd_type='gaussian'), ctx=[mx.cpu()])
