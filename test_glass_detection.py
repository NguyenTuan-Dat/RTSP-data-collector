...
while (cap.isOpened()):
    ...
    if OUR_FACE_DETECTION:
        print("OUR_FACE_DETECTION", OUR_FACE_DETECTION)
    ...
    cv2.putText(img, str(time.time() - t), (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2,
                cv2.LINE_AA)
    ...
    if k == ord('c'):
        print("ALOALO")
        OUR_FACE_DETECTION = not OUR_FACE_DETECTION
